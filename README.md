...
- **Data and research engineering.** Python (pandas, scikit-learn) pipelines for survey and interview data, Qualtrics API automation, RAG databases.
- **Infrastructure.** A self-hosted homelab running CI/CD, monitoring, and about 30 services via GitOps.

### Selected work

- **[super.ucla.edu](https://super.ucla.edu)** is the public site for a statewide substance-use prevention resource used by providers across California. I run it end to end: content, WordPress/JetEngine CMS, search, hosting, and analytics. I also built its grant-application portal, including the data pipeline and reviewer portal.
